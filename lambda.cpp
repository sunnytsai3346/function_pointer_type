...
int main() {
    ...
    // use lambda way  with comparator 
    std::set<Person, fp> persons([](const Person lperson, const Person rperson) {
    ...
    std::set<Person, fp> personsByName([](const Person lperson, const Person rperson) {
